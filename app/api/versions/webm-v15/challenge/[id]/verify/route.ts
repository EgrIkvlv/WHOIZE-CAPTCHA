import { verifyMatchedMotionChallenge } from "@/apps/captcha-versions/server/matched-motion-service";
...
export async function POST(
  ...
  try {
    ...
    console.error("Unable to verify v1.5 matched-motion challenge", error);
    return Response.json(
