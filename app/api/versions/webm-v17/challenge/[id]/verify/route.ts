import { verifyStochasticReadableChallenge } from "@/apps/captcha-versions/server/regenerative-motion-service";
...
export async function POST(
  ...
  try {
    ...
    console.error("Unable to verify v1.7 stochastic challenge", error);
    return Response.json(
