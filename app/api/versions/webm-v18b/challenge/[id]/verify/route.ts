import { verifyReadableSoloChallenge } from "@/apps/captcha-versions/server/readable-decoy-service";
...
export async function POST(
  ...
  try {
    ...
    console.error("Unable to verify v1.8b readable-solo challenge", error);
    return Response.json(
