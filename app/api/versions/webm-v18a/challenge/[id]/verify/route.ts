import { verifyReadableDecoyChallenge } from "@/apps/captcha-versions/server/readable-decoy-service";
...
export async function POST(
  ...
  try {
    ...
    console.error("Unable to verify v1.8a readable-decoy challenge", error);
    return Response.json(
