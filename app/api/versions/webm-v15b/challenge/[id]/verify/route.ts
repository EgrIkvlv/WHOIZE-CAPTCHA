import { verifyHumanTunedChallenge } from "@/apps/captcha-versions/server/matched-motion-service";
...
export async function POST(
  ...
  try {
    ...
    console.error("Unable to verify v1.5b human-tuned challenge", error);
    return Response.json(
