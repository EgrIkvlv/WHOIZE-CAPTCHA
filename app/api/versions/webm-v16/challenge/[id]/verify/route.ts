import { verifyRegenerativeMotionChallenge } from "@/apps/captcha-versions/server/regenerative-motion-service";
...
export async function POST(
  ...
  try {
    ...
    console.error("Unable to verify v1.6 regenerative challenge", error);
    return Response.json(
